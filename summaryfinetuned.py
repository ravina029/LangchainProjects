...
llm = HuggingFaceHub(repo_id="codebasics/finetunedN-facebook-bart-samsum",model_kwargs={"temperature":0.1, "min_length":20,"max_length":500})
...
if summarize_button or text_input:  # Summarize on button click or text input
    ...
    #summary_text = summarizer.summarize(summary)  
